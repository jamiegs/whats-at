...
This is a sample template for whats-at-abes - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name whats-at-abes --query 'Stacks[].Outputs'
```
